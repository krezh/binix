...
impl Hash {
    ...
    pub fn from_typed(s: &str) -> BinixResult<Self> {
    ...
    ///
    /// This is the canonical representation of hashes in the Binix database.
...
fn decode_hash(s: &str, typ: &'static str, expected_bytes: usize) -> BinixResult<Vec<u8>> {
