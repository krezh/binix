...
pub type BinixResult<T> = Result<T, BinixError>;
...
impl StdError for BinixError {}

#[cfg(feature = "nix_store")]
impl From<cxx::Exception> for BinixError {
...
impl From<io::Error> for BinixError {
    fn from(error: io::Error) -> Self {
        Self::IoError { error }
    }
}

impl From<super::signing::Error> for BinixError {
    fn from(error: super::signing::Error) -> Self {
        Self::SigningError(error)
    }
}

impl From<super::hash::Error> for BinixError {
