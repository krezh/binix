...
impl CacheName {
    ...
    pub fn new(name: String) -> BinixResult<Self> {
...
impl FromStr for CacheName {
    ...
    fn from_str(name: &str) -> BinixResult<Self> {
...
impl CacheNamePattern {
    ...
    pub fn new(pattern: String) -> BinixResult<Self> {
...
impl FromStr for CacheNamePattern {
    ...
    fn from_str(pattern: &str) -> BinixResult<Self> {
...
fn validate_cache_name(name: &str, allow_wildcards: bool) -> BinixResult<()> {
    ...
    if valid {
        ...
        Err(BinixError::InvalidCacheName {
            name: name.to_owned(),
        })
    }
}
