...
impl NixKeypair {
    ...
    pub fn generate(name: &str) -> BinixResult<Self> {
    ...
    pub fn from_str(keypair: &str) -> BinixResult<Self> {
    ...
    ///     binix-test:msdoldbtlongtt0/xkzmcbqihd7yvy8iomajqhnkutsl3b1pyyyc0mgg2rs0ttzzuyuk9rb2zphvtpes71mlha==
    ...
    ///
    /// For example, it can look like:
    ///     binix-test:C929acssgtJoINkUtLbc81GFJPUW9maR77TxEu9ZpRw=
    ...
    /// Verifies a message.
    pub fn verify(&self, message: &[u8], signature: &str) -> BinixResult<()> {
...
impl NixPublicKey {
    ...
    pub fn from_str(public_key: &str) -> BinixResult<Self> {
...
fn validate_name(name: &str) -> BinixResult<()> {
