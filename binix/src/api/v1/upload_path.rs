...
pub const BINIX_NAR_INFO: &str = "X-Binix-Nar-Info";
...
///
/// 1. At the beginning of the PUT body. The `X-Binix-Nar-Info-Preamble-Size`
///    header must be set to the size of the JSON.
/// 2. Through the `X-Binix-Nar-Info` header.
///
