...
use crate::{BinixError, BinixResult};
...
pub unsafe fn open_nix_store() -> BinixResult<FfiNixStore> {
...
impl AsyncWriteAdapter {
    ...
    pub async fn write_all(mut self, mut writer: Box<dyn AsyncWrite + Unpin>) -> BinixResult<()> {
        ...
        match self.receiver.poll_recv(cx) {
            ...
            Poll::Ready(Some(message)) => {
                ...
                match message {
                    ...
                    Error(exception) => {
                        let error = BinixError::CxxError { exception };
