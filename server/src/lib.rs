...
pub struct StateInner {
    /// The Binix Server configuration.
    config: Config,
...
struct RequestStateInner {
    ...
    ///
    /// This is purely informational and used to add the `X-Binix-Cache-Visibility`
    /// header in responses.
...
impl RequestStateInner {
    ...
    ///
    /// The APIs encompass both the Binix API and the Nix binary
    /// cache API.
